...
ALTER TABLE guest REPLICA IDENTITY FULL;

ALTER TABLE addon REPLICA IDENTITY FULL;

ALTER TABLE roomtype REPLICA IDENTITY FULL;

ALTER TABLE room REPLICA IDENTITY FULL;

ALTER TABLE booking REPLICA IDENTITY FULL;

ALTER TABLE booking_room REPLICA IDENTITY FULL;

ALTER TABLE booking_addon REPLICA IDENTITY FULL;
